; COAL Project Fall-2021
; Group Members
; I18-1661 Ahmad Arif
; 19I-0436 Fajr Naveed
; COAL Semester Project
; Instructor: Sir Shams Farooq and Sir Fakhar Abbas
; Course Code: EE 229
; Game: Match Three Puzzle Game on masm615
...
.data
	...
	rows word 7				; Rows of grid (2D-Array)
	columns word 7				; Columns of grid (2D-Array)
    ...
    ; *****************
	; Front screen data	; Time delay of 0.35 secs
	; *****************
    ...
    letterClassicC byte "C$"
    letterClassicL byte "L$"
    letterClassicA byte "A$"
    letterClassicS byte "S$"
    letterClassicSS byte "S$"
    letterClassicI byte "I$"
    letterClassicCC byte "C$"

    ; **********************
	; Game rules screen data ; Time delay of 10 secs
	; **********************

    rulePrompt0 byte "GAME RULES$"	
    rulePrompt1 byte "The game is played by swiping candies, in any direction$"
    rulePrompt2 byte "to create sets of 3 or more matching candies. When matched,$"
    rulePrompt3 byte "the candies will crush and shift the candies above them,$"
    rulePrompt4 byte "allowing you to accomplish a series of different goals.$"
    rulePrompt5 byte "Match more than 3 candies to create combos$"
...
; ===================================================================================================================================================================
	...
	level1 proc
		...
		; *********************************************
		; Mouse simulation and level-1 gameplay started
		; *********************************************
		...
		simulation:
			...
			cmp bombed, 1		; If number is bombed draw board again
			je draw_board
...
; ===================================================================================================================================================================
	...
	level2 proc
		...
		; *********************************************
		; Mouse simulation and level-2 gameplay started
		; *********************************************
...
; ===================================================================================================================================================================
	...
	level3 proc
		...
		; *********************************************
		; Mouse simulation and level-3 gameplay started
		; *********************************************
...
; ===================================================================================================================================================================
	...
	; ***********************************
	; Procedure for displaying Game Title
	; ***********************************
...
; ===================================================================================================================================================================
    ...
    ; *********************************
	; Procedure for printing game rules
	; *********************************
    ...
    gameRules PROC
        ...
        mov x, 32
		mov y, 7
		mov si, offset rulePrompt0
		mov color, 4
		call displayScreenStr

        mov x, 10
		mov y, 10
		mov si, offset rulePrompt1
		mov color, 12
		call displayScreenStr

        mov x, 10
		mov y, 13
		mov si, offset rulePrompt2
		mov color, 13
		call displayScreenStr

        mov x, 10
		mov y, 16
		mov si, offset rulePrompt3
		mov color, 14
		call displayScreenStr

        mov x, 10
		mov y, 19
		mov si, offset rulePrompt4
		mov color, 15
		call displayScreenStr

        mov time_delay, 10000
...
; ===================================================================================================================================================================
	...
	playerProfile proc
		...
		mov color, 4	; Setting color for the border
...
; ===================================================================================================================================================================
	...
	; ***********************************
	; Procedure for displaying Game Over
	; ***********************************
